...
public class PersistenceManagerFactory {
	...
	private PersistenceManagerFactory() {
		...
		config.addAnnotatedClass(com.stars.persistence.dao.Passwords.class);
		config.addAnnotatedClass(com.stars.persistence.dao.Profiles.class);
		config.addAnnotatedClass(com.stars.persistence.dao.Talents.class);
		config.addAnnotatedClass(com.stars.persistence.dao.UserProfiles.class);
	}
	...
	static Configuration getConfiguration() {
		if (hibernateConfigFile == null) {
			hibernateConfigFile = System
					.getProperty(PERSISTENCE_HIBERNATE_CFG_FILE);
		}
